 ...
 * Module           : Common functions File
 * Source filename  : schema.js
 * Description      : This file is to set the schema for the all model related functions.
...
module.exports = function (schema) {
    ...
    schema.statics.getDataById = function (id, options) {
        ...
        // self.findById(id).populate([{ path: 'seeker', select: 'name' }, { path: 'job', select: 'title' }]).lean().exec(function (err, data) {
        //     callback(err, data);
        // });
    };
